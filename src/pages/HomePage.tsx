...
const HomePage: React.FC = () => {
  ...
  const [selectedCatId, setSelectedCatId] = useState<string>('veg');
        ...
        <div className="max-w-xl mx-auto bg-white rounded-xl shadow-2xl p-6 md:p-10 border-t-8 border-[#2d5a27] mt-12">
          ...
          <div className="space-y-6">
            <div className="group">
              ...
              <div className="w-full border-2 border-gray-100 rounded-lg py-3 px-4 bg-gray-50 font-sans text-gray-800 flex justify-between items-center">
                <span>{currentCategory?.name || 'Vegetables'}</span>
